...
class RouteResponse(BaseModel):
    next_step: Literal["recommend_product_node", "crm_message_node", "search_node", "message_feedback_node", "generate_persona_node", "bulk_persona_node", "product_registration_node"] = Field(
