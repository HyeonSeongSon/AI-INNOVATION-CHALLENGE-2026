    ...
    async def get_persona_info(self, persona_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            persona_info = {
                ...
                "스크린 사용": f"하루 {api_data.get('daily_screen_hours')}시간" if api_data.get('daily_screen_hours') else None,
                "쇼핑 스타일": api_data.get("shopping_style", []),
