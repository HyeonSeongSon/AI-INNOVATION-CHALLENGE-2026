...
from .prompt.generate_persona_search_query_prompt import build_generate_persona_search_query_prompt

async def generate_persona_search_query(llm, persona_info) -> Dict:
    prompt = build_generate_persona_search_query_prompt(persona_info)
...
if __name__ == "__main__":
    ...
    response = asyncio.run(generate_persona_search_query(llm, persona_info))
