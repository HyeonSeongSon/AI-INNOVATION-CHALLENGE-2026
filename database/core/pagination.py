...
ANALYSIS_RESULTS_DEFAULT_PAGE_SIZE: int = int(os.getenv("ANALYSIS_RESULTS_DEFAULT_PAGE_SIZE", "20"))
ANALYSIS_RESULTS_MAX_PAGE_SIZE: int     = int(os.getenv("ANALYSIS_RESULTS_MAX_PAGE_SIZE", "100"))
