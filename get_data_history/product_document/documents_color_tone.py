...
from get_data_history.product_document.document_color_prompts import build_color_tone_category_product_prompts
...
OUTPUT_FILE = Path(__file__).parent.parent.parent / "data" / "v2_product_data_structured_color_tone.jsonl"
...
def build_prompt(product: dict) -> str:
    ...
    return build_color_tone_category_product_prompts(extra_category, document, _COLOR_CATEGORIES)
