...
# 입력 파일 경로
input_file = r"C:\Users\user\Documents\GitHub\AI-INNOVATION-CHALLENGE-2026\data\product_document\product_documents_with_url_251218.jsonl"

# 출력 파일 경로
output_included = "./data/product_document/product_documents_included_tags.jsonl"
output_excluded = "./data/product_document/product_documents_excluded_tags.jsonl"
